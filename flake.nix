{
  ...
  outputs =
    ...
    let
      ...
      nixConfig = import ./system/configuration.nix (extraSpecialArgs // { inherit lib; });
    ...
    rec {
      nixosConfigurations.${hostname} = nixpkgs.lib.nixosSystem {
        ...
        modules = [
          ...
          home-manager.nixosModules.home-manager
          {
            home-manager = {
              ...
              users.${username} = {
                ...
                imports = [ inputs.handy.homeManagerModules.default ] ++ (lib.my.importFrom ./home);
              };
            };
          }
          ...
          (import ./system/nixflix.nix { inherit pkgs lib; })
        ];
      };
